...
#made some typos and thereby almost made me loose my sanity bcs I had to figure out the exact typos made for each download error. So for 77 of the 84 #cases only the lines 80-83 and 100-106 are needed. Lines 84-102 are only needed to catch the typo-sheets ¯\_(ツ)_/¯
